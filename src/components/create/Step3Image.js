      ...
      <div className="mt-6 p-8 bg-white dark:bg-zinc-900 rounded-xl shadow-lg">
        ...
        {generatedImageUrl && (
          <Fragment>
            ...
            <LogoEditor baseImage={generatedImageUrl} logo={logo} setLogo={setLogo} onMerge={handleMerge} />
            <div className="mt-6 flex flex-col sm:flex-row justify-center gap-3">
              <button onClick={handleAcceptImage} className="bg-blue-600 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded-lg">Aceitar sem Logo</button>
